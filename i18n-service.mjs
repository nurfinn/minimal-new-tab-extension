...
export const ENGLISH_FALLBACKS = Object.freeze({
  ...
  siteTitleTooLong: 'Use 500 characters or fewer.',
  urlLabel: 'Address',
  invalidSiteUrl: 'Enter a valid website address, for example github.com.',
  folderLabel: 'Folder',
  delete: 'Delete',
  ...
  folderNameTooLong: 'Use 200 characters or fewer.',
  ...
  imageLabel: 'Image',
  backgroundImageLimits: 'PNG, JPEG, or WebP — up to 3 MB and 4096 px per side.',
  backgroundSelectedFile: 'Selected for saving: $1',
  overlayColor: 'Overlay color',
  opacity: 'Opacity',
  singleKeyShortcutsLabel: 'Single-key shortcuts',
  singleKeyShortcutsDescription: 'Use A, F, and S when no dialog or field is active.',
  reset: 'Reset',
  ...
  importSelectedFile: 'Selected file: $1',
  ...
  reorderFolder: 'Reorder folder $1. Use the Up and Down arrow keys.',
  ...
  dragSite: 'Drag $1',
  reorderSite: 'Reorder $1. Use the Left and Right arrow keys.',
  itemMoved: 'Moved $1 to position $2 of $3.',
  edit: 'Edit',
  editSite: 'Edit $1',
